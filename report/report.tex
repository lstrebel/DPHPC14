...
%		Instead it must be considered as a source of a more general approach to the implementation of BFS for the environment of a particular kind of SMA system.
	...
	\section{Experiments}\label{sec:expe} % Roughtly two pages - half a column. + 4 plots
		...
		\begin{itemize}
			\item \textbf{Euler}. Intel Xeon E5-2697v2 processor (2.7 GHz nominal, 3.0-3.5 GHz peak, HT enabled) with 12 physical and 24 logical cores. GNU GCC 4.8.2 compiler with -O2 flag. 
			...
			%TODO: What version of accelerator
		...
		\begin{itemize}
			\item \textbf{Million}. A huge real world graph containing 1 million nodes and $\sim$3 million edges.
		...
		All of them return a distance map from one source vertex to all reachable vertices in the graph and are based on OpenMP for synchronization.
