...
%	All the vertices with the same minimal distance to the source are called level.
	...
	\section{Discussion}\label{sec:disc} % Roughtly column. + ~1-2 references + 1 table
		...
		This analysis also highlights the dependency of the performance of the parallel variants of BFS on the characteristics of the target graph, however it is not clear what exact characteristics affect the performance of Optimistic BFS and how they do so. 
